            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color:  _lbh.containsMouse ? Theme.surfaceVariant : "transparent"
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color:  _cbh.containsMouse ? Theme.surfaceVariant : "transparent"
                        Behavior on color { ColorAnimation { duration: Theme.durationFast } }
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color:  _rbh.containsMouse ? Theme.surfaceVariant : "transparent"
                        Behavior on color { ColorAnimation { duration: Theme.durationFast } }
